...
<body>
    ...
    <script language="javascript" src="view/static/js/index.js" /></script>
    <script type="text/javascript">document.getElementById('loading-msg').innerHTML = 'Loading Private-Key Generator...';</script>
    <script language="JavaScript" type="text/javascript" src="../view/static/js/DoozR/genkey.js"></script>

    <div style="padding-top:80px;text-align:center;width:400px;height:448px;position:relative;margin-left:auto;margin-right:auto;margin-top:120px;margin-bottom:auto;">
            <div id="admin-form">
                <noscript>
                    <img src="view/static/img/enablejs.png" />
                </noscript>
            </div>
    </div>
