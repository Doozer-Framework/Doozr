...
require_once DOOZR_DOCUMENT_ROOT.'Module/DoozR/Pear/_Cache/Container.php';
...
* @version  $Id$
*/
class Cache_Container_memcached extends Cache_Container
{
    ...
    */
    function getFilename($id, $group)
    {
        ...
        $dir = $this->cache_dir.$group.DIRECTORY_SEPARATOR;
