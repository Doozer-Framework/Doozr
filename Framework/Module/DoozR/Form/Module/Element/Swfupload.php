...
require_once DOOZR_DOCUMENT_ROOT.'Core/Module/doozR_Formhelper/classes/input.aclass.php';
...
class Swfupload extends AInput
{
    ...
    public function render($tabcount = 0)
    {
		...
		$html .= file_get_contents(DOOZR_DOCUMENT_ROOT.'Core/Module/doozR_Formhelper/lib/includes/swfupload/inline.js');
